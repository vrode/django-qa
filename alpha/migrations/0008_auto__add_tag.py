...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('alpha_tag_targets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tag', models.ForeignKey(orm['alpha.tag'], null=False)),
            ('question', models.ForeignKey(orm['alpha.question'], null=False))
        ))
        db.create_unique('alpha_tag_targets', ['tag_id', 'question_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('alpha_tag_targets')
    ...
    models = {
        ...
        'alpha.tag': {
            ...
            'targets': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['alpha.Question']", 'symmetrical': 'False'})
        }
    }
